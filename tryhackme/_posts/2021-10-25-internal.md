...
As suspected, we have a WordPress website! I ran another `gobuster` scan on internal.thm/blog/ so as to enumerate any hidden directories. In the meantime, let's take a look at /phpmyadmin:
...
After looking through all of the directories, the **/wp-login.php** directory stands out the most as it actually brings us to a WordPress login page:
