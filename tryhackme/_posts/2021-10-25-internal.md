...
As suspected, we have a WordPress website! I ran another `gobuster` scan on /blog directory so as to enumerate any other sub-directories. In the meantime, let's take a look at /phpmyadmin:
