...
Since a common theme in this room so far has been 'pickles', perhaps the farm grows pickles? (even though pickles can't really be grown :smile:) I tried both 'pickles' and 'pickle':
